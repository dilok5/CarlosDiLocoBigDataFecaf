 # 🌡️ Big Data FECAF - Dashboard IoT  Projeto focado na ingestão, persistência e visualização de dados de sensores IoT, desenvolvido para a disciplina de **Big Data**. A aplicação utiliza **Streamlit** para a interface, **PostgreSQL (Render)** para persistência e **Plotly** para análise gráfica.  ![Dashboard Preview](https://github.com/user-attachments/assets/7dfa1d62-cf1a-49a9-a966-c7bd3c936049)  
